...
const SecurityOption = () => {
  ...
  return (
    <div className="relative h-min-screen pt-30">
      ...
      >
        <OptionalCard title="Authentication Preference" isSkip={true} subTitle="Paste their referral link into the field below.">
          <div className="w-full bg-[#223F6C] p-3 md:p-7 rounded-3xl shadow-md">
            <div className="flex flex-row">
              ...
              <div className="flex flex-col md:gap-5 gap-2 w-auto px-3 ">
                <div className="md:text-[15px] text-[12px]">Google Authenticator</div>
                <div className="text-[#FFFFFFB8] md:text-[12px] text-[8px]"> 
                  We recommend using Google Authenticator. Please download the
                  app from <a className="text-[#05F691] underline">Google Play Store</a> or <a className="text-[#05F691] underline">Apple App Store</a> on your mobile
                  device.
                </div>
              </div>
