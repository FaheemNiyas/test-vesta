...
import { ComIcon1, ComIcon2, ComIcon3, ComIcon4, ComIcon5, ComIcon6, ComIcon7, ComIcon8 } from "@/constants";
...
export default function TrendingCompanies() {
  ...
  return (
    <div className="flex flex-col w-full justify-center items-center gap-10 py-40">
        <div className="text-center text-[55px] font-medium font-['Inter'] headline-gradient-1 w-fit">Trending Companies</div>
